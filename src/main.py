...
async def on_message(message):
    ...
    if message.content == "/init":
        ...
        embed = discord.Embed(
            ...
            description="""
私はロケッターズサーバの案内イルカのカイル君だよ!よろしくね!
...
そのためメンションのやり方をここでマスターしましょう!!
        ...
        embed.add_field(
            name="全体通知",
            value="""
            > サーバに参加してる人全員に通知を送りたいときはメッセージのあとに __`@everyone`__ と入力すると通知を送れます!
            """,
            inline=False,
        )
        embed.add_field(
            name="オンライン参加者通知",
            value="""
            > サーバに参加していて現在オンラインの人にのみ通知を送りたいときはメッセージのあとに __`@here`__ と入力すると通知を送れます!
            """,
            inline=False,
        )
        embed.add_field(
            name="特定ロール参加者通知",
            value="""
            > サーバに参加していて特定ロール参加者の人にのみ通知を送りたいときはメッセージのあとに __`@ロール名`__ と入力すると通知を送れます!
            """,
            inline=False,
        )
        embed.add_field(
            name="個人通知",
            value="""
            > サーバに参加している個人にのみ通知を送りたいときはメッセージのあとに __`@ユーザ名`__ と入力すると通知を送れます!
            """,
            inline=False,
        )
        embed.set_thumbnail(
